function deletePayroll(id, doc_num) {
    modal_html = `
    <div class="modal font-roboto" id="modal">
        <div class="modal-content p-2" id="modal-content">
            <header id="modal-header">
                <h3 class="mb-5 txt-center">Eliminar documento</h3>
                <div class="txt-center">
                    ¿Está seguro que desea eliminar el documento <b>${doc_num}</b>?
                </div>
            </header>
            <div class="form-single-button-container w-100">
                <a class="form-button form-button-submit w-100" href='/delete-payroll/${id}'>
                    <span>
                        Confirmar
                    </span>
